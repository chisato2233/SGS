...
const TArray<FSGSGeneralDefinition>& Definitions()
{
	static const TArray<FSGSGeneralDefinition> Values = {
		{ TEXT("caocao"), TEXT("曹操"), SGSGameplayTags::Faction_Wei.GetTag(), 4, { TEXT("Jianxiong") } },
		{ TEXT("simayi"), TEXT("司马懿"), SGSGameplayTags::Faction_Wei.GetTag(), 3, { TEXT("Fankui") } },
		{ TEXT("xiahoudun"), TEXT("夏侯惇"), SGSGameplayTags::Faction_Wei.GetTag(), 4, {} },
		{ TEXT("liubei"), TEXT("刘备"), SGSGameplayTags::Faction_Shu.GetTag(), 4, { TEXT("Rende") } },
		...
		{ TEXT("sunquan"), TEXT("孙权"), SGSGameplayTags::Faction_Wu.GetTag(), 4, { TEXT("Zhiheng") } },
